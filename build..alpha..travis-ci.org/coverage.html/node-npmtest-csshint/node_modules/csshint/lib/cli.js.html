...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-csshint/node_modules/csshint/lib/cli.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-csshint/node_modules/csshint/lib/cli.js</span></h1>
    <h2>
        
        Statements: <span class="metric">25.42% <small>(15 / 59)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-csshint/node_modules/csshint/lib/</a> &#187; cli.js</div>
</div>
<div class="body">
 ...
 */
&nbsp;
var showDefaultInfo = <span class="fstat-no" title="function not covered" >function showDefaultInfo() {</span>
<span class="cstat-no" title="statement not covered" >    console.log('');</span>
<span class="cstat-no" title="statement not covered" >    console.log(_package2.default.name + ' v' + _package2.default.version);</span>
<span class="cstat-no" title="statement not covered" >    console.log(_chalk2.default.bold.green((0, _util.formatMsg)(_package2.default.description)));</span>
};
&nbsp;
/**
 * 校验结果报告
 ...
 */
var report = <span class="fstat-no" title="function not covered" >function report(errors) {</span>
<span class="cstat-no" title="statement not covered" >    var t12 = true;</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            _edpCore.log.info(error.path);</span>
<span class="cstat-no" title="statement not covered" >            error.messages.forEach(<span class="fstat-no" title="function not covered" >function (message) {</span></span>
<span class="cstat-no" title="statement not covered" >                var ruleName = message.ruleName || '';</span>
<span class="cstat-no" title="statement not covered" >                var msg = '→ ' + (ruleName ? _chalk2.default.bold(ruleName) + ': ' : '');</span>
                // 全局性的错误可能没有位置信息
<span class="cstat-no" title="statement not covered" >                if (typeof message.line === 'number') {</span>
<span class="cstat-no" title="statement not covered" >                    msg += 'line ' + message.line;</span>
<span class="cstat-no" title="statement not covered" >                    if (typeof message.col === 'number') {</span>
<span class="cstat-no" title="statement not covered" >                        msg += ', col ' + message.col;</span>
                    }
<span class="cstat-no" title="statement not covered" >                    msg += ': ';</span>
                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                msg += message.colorMessage || message.message;</span>
<span class="cstat-no" title="statement not covered" >                _edpCore.log.warn(msg);</span>
            });
        });
<span class="cstat-no" title="statement not covered" >        t12 = false;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (t12) {</span>
<span class="cstat-no" title="statement not covered" >        _edpCore.log.info('Congratulations! Everything gone well, you are T12!');</span>
    } else {
...
<span class="cstat-no" title="statement not covered" >        args.push('.');</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (args[0] === '--version' || args[0] === '-v') {</span>
<span class="cstat-no" title="statement not covered" >        showDefaultInfo();</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var patterns = ['**/*.css', '!**/{output,test,node_modules,asset,dist,release,doc,dep,report}/**'];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var candidates = (0, _util.getCandidates)(args, patterns);</span>
<span class="cstat-no" title="statement not covered" >    var count = candidates.length;</span>
&nbsp;
...
&nbsp;
     ...
     * @inner
     */
<span class="cstat-no" title="statement not covered" >    var callback = <span class="fstat-no" title="function not covered" >function callback() {</span></span>
<span class="cstat-no" title="statement not covered" >        count--;</span>
<span class="cstat-no" title="statement not covered" >        if (!count) {</span>
<span class="cstat-no" title="statement not covered" >            report(errors);</span>
        }
    };
&nbsp;
    // 遍历每个需要检测的 css 文件
<span class="cstat-no" title="statement not covered" >    candidates.forEach(<span class="fstat-no" title="function not covered" >function (candidate) {</span></span>
<span class="cstat-no" title="statement not covered" >        var readable = (0, _fs.createReadStream)(candidate, {</span>
            encoding: 'utf8'
        });
<span class="cstat-no" title="statement not covered" >        readable.on('data', <span class="fstat-no" title="function not covered" >function (chunk) {</span></span>
<span class="cstat-no" title="statement not covered" >            var file = {</span>
                content: chunk,
                path: candidate
            };
<span class="cstat-no" title="statement not covered" >            (0, _checker.check)(file, errors, callback);</span>
        });
<span class="cstat-no" title="statement not covered" >        readable.on('error', <span class="fstat-no" title="function not covered" >function (err) {</span></span>
