...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-csshint/node_modules/csshint/lib/util.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-csshint/node_modules/csshint/lib/util.js</span></h1>
    <h2>
        
        Statements: <span class="metric">16.34% <small>(33 / 202)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">15.92% <small>(32 / 201)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric">1 branch</span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-csshint/node_modules/csshint/lib/</a> &#187; util.js</div>
</div>
<div class="body">
...
444
445
446</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
 ...
 */
<span class="fstat-no" title="function not covered" >function trim(source) {</span>
<span class="cstat-no" title="statement not covered" >    if (!source) {</span>
<span class="cstat-no" title="statement not covered" >        return '';</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    return String(source).replace(WHITESPACE, '');</span>
}
&nbsp;
/**
 ...
 * @return {Array} 结果
 */
<span class="fstat-no" title="function not covered" >function times(n, iterator, context) {</span>
<span class="cstat-no" title="statement not covered" >    var accum = new Array(Math.max(0, n));</span>
<span class="cstat-no" title="statement not covered" >    for (var i = 0; i &lt; n; i++) {</span>
<span class="cstat-no" title="statement not covered" >        accum[i] = iterator.call(context, i);</span>
    }
 ...
 */
<span class="fstat-no" title="function not covered" >function formatMsg(msg) {</span>
<span class="cstat-no" title="statement not covered" >    var spaceCount = arguments.length &gt; 1 &amp;&amp; arguments[1] !== undefined ? arguments[1] : 0;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var space = '';</span>
<span class="cstat-no" title="statement not covered" >    times(spaceCount, <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >        space += ' ';</span>
    });
<span class="cstat-no" title="statement not covered" >    return space + msg;</span>
}
&nbsp;
/**
 * 根据参数以及模式匹配相应的文件
 ...
 */
<span class="fstat-no" title="function not covered" >function getCandidates(args, patterns) {</span>
<span class="cstat-no" title="statement not covered" >    var candidates = [];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    args = args.filter(<span class="fstat-no" title="function not covered" >function (item) {</span></span>
...
<span class="cstat-no" title="statement not covered" >        candidates = _edpCore.glob.sync(patterns);</span>
    } else {
...
<span class="cstat-no" title="statement not covered" >            var target = args[i];</span>
<span class="cstat-no" title="statement not covered" >            if (!(0, _fs.existsSync)(target)) {</span>
<span class="cstat-no" title="statement not covered" >                _edpCore.log.warn('No such file or directory %s', target);</span>
<span class="cstat-no" title="statement not covered" >                continue;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            var stat = (0, _fs.statSync)(target);</span>
<span class="cstat-no" title="statement not covered" >            if (stat.isDirectory()) {</span>
<span class="cstat-no" title="statement not covered" >                target = target.replace(/[\/|\\]+$/, '');</span>
<span class="cstat-no" title="statement not covered" >                candidates.push.apply(candidates, _edpCore.glob.sync(target + '/' + patterns[0]));</span>
            }
            /* istanbul ignore else */
            else <span class="cstat-no" title="statement not covered" >if (stat.isFile()) {</span>
<span class="cstat-no" title="statement not covered" >                    candidates.push(target);</span>
                }
        }
    }
&nbsp;
 ...
 */
<span class="fstat-no" title="function not covered" >function getIgnorePatterns(file) {</span>
<span class="cstat-no" title="statement not covered" >    if (!(0, _fs.existsSync)(file)) {</span>
<span class="cstat-no" title="statement not covered" >        return [];</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var patterns = (0, _fs.readFileSync)(file, 'utf-8').split(/\r?\n/g);</span>
<span class="cstat-no" title="statement not covered" >    return patterns.filter(<span class="fstat-no" title="function not covered" >function (item) {</span></span>
<span class="cstat-no" title="statement not covered" >        return item.trim().length &gt; 0 &amp;&amp; item[0] !== '#';</span>
    });
}
&nbsp;
var _IGNORE_CACHE = {};
 ...
 * @return {boolean}
 */
<span class="fstat-no" title="function not covered" >function isIgnored(file) {</span>
<span class="cstat-no" title="statement not covered" >    var name = arguments.length &gt; 1 &amp;&amp; arguments[1] !== undefined ? arguments[1] : '.csshintignore';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var ignorePatterns = null;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    file = _edpCore.path.resolve(file);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var key = name + '@' + _edpCore.path.dirname(file);</span>
<span class="cstat-no" title="statement not covered" >    if (_IGNORE_CACHE[key]) {</span>
<span class="cstat-no" title="statement not covered" >        ignorePatterns = _IGNORE_CACHE[key];</span>
    } else {
<span class="cstat-no" title="statement not covered" >        var options = {</span>
            name: name,
            factory: <span class="fstat-no" title="function not covered" >function factory(item) {</span>
<span class="cstat-no" title="statement not covered" >                var config = {};</span>
<span class="cstat-no" title="statement not covered" >                getIgnorePatterns(item).forEach(<span class="fstat-no" title="function not covered" >function (line) {</span></span>
<span class="cstat-no" title="statement not covered" >                    config[line] = true;</span>
                });
<span class="cstat-no" title="statement not covered" >                return config;</span>
            }
        };
<span class="cstat-no" title="statement not covered" >        ignorePatterns = _edpCore.util.getConfig(_edpCore.path.dirname(file), options);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        _IGNORE_CACHE[key] = ignorePatterns;</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    var bizOrPkgRoot = process.cwd();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >        bizOrPkgRoot = _edpCore.path.getRootDirectory();</span>
    } catch (ex) {}
&nbsp;
<span class="cstat-no" title="statement not covered" >    var dirname = _edpCore.path.relative(bizOrPkgRoot, file);</span>
<span class="cstat-no" title="statement not covered" >    var isMatch = _edpCore.glob.match(dirname, Object.keys(ignorePatterns));</span>
&nbsp;
 ...
 * @return {string} 当前行内容
 */
<span class="fstat-no" title="function not covered" >function getLineContent(line, fileData, isReplaceSpace) {</span>
<span class="cstat-no" title="statement not covered" >    var content = fileData.split('\n')[line - 1];</span>
<span class="cstat-no" title="statement not covered" >    if (isReplaceSpace) {</span>
<span class="cstat-no" title="statement not covered" >        content = content.replace(/\s*/, '');</span>
    }
 ...
 */
<span class="fstat-no" title="function not covered" >function changeColorByIndex(source, startIndex, colorStr) {</span>
<span class="cstat-no" title="statement not covered" >    var ret = '';</span>
<span class="cstat-no" title="statement not covered" >    if (source) {</span>
<span class="cstat-no" title="statement not covered" >        var colorStrLen = colorStr.length;</span>
<span class="cstat-no" title="statement not covered" >        var endIndex = startIndex + colorStrLen;</span>
<span class="cstat-no" title="statement not covered" >        ret = '' + source.slice(0, startIndex) // colorStr 前面的部分</span>
 ...
 * @return {string} 改变颜色后的字符串
 */
<span class="fstat-no" title="function not covered" >function changeColorByStartAndEndIndex(source) {</span>
<span class="cstat-no" title="statement not covered" >    var startIndex = arguments.length &gt; 1 &amp;&amp; arguments[1] !== undefined ? arguments[1] : 0;</span>
<span class="cstat-no" title="statement not covered" >    var endIndex = arguments.length &gt; 2 &amp;&amp; arguments[2] !== undefined ? arguments[2] : 0;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!source) {</span>
<span class="cstat-no" title="statement not covered" >        return '';</span>
    }
...
<span class="cstat-no" title="statement not covered" >    endIndex -= 1;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return '' + source.slice(0, startIndex) // colorStr 前面的部分</span>
    + _chalk2.default.magenta(source.slice(startIndex, endIndex)) // colorStr 的部分
    + source.slice(endIndex, source.length); // colorStr 后面的部分
}
&nbsp;
...
<span class="fstat-no" title="function not covered" >function getPropertyValue(text) {</span>
    /* jshint maxstatements: 71, maxcomplexity: 43 */
&nbsp;
<span class="cstat-no" title="statement not covered" >    var parts = [];</span>
<span class="cstat-no" title="statement not covered" >    var arr = _postcss2.default.list.space(String(text));</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        var temp = void 0;</span>
&nbsp;
        // dimension
<span class="cstat-no" title="statement not covered" >        if (/^([+\-]?[\d\.]+)([a-z]+)$/i.test(arr[i])) {</span>
<span class="cstat-no" title="statement not covered" >            part.value = +RegExp.$1;</span>
<span class="cstat-no" title="statement not covered" >            part.units = RegExp.$2;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            switch (part.units.toLowerCase()) {</span>
                case 'em':
                case 'rem':
                case 'ex':
                case 'px':
                ...
                case 'vmax':
                case 'vmin':
<span class="cstat-no" title="statement not covered" >                    part.type = 'length';</span>
<span class="cstat-no" title="statement not covered" >                    break;</span>
&nbsp;
                case 'deg':
                case 'rad':
                case 'grad':
<span class="cstat-no" title="statement not covered" >                    part.type = 'angle';</span>
<span class="cstat-no" title="statement not covered" >                    break;</span>
&nbsp;
                case 'ms':
                case 's':
<span class="cstat-no" title="statement not covered" >                    part.type = 'time';</span>
<span class="cstat-no" title="statement not covered" >                    break;</span>
&nbsp;
                case 'hz':
                case 'khz':
<span class="cstat-no" title="statement not covered" >                    part.type = 'frequency';</span>
<span class="cstat-no" title="statement not covered" >                    break;</span>
&nbsp;
                case 'dpi':
                case 'dpcm':
<span class="cstat-no" title="statement not covered" >                    part.type = 'resolution';</span>
<span class="cstat-no" title="statement not covered" >                    break;</span>
&nbsp;
                default:
<span class="cstat-no" title="statement not covered" >                    part.type = 'dimension';</span>
            }
        }
        // percentage
        else <span class="cstat-no" title="statement not covered" >if (/^([+\-]?[\d\.]+)%$/i.test(arr[i])) {</span>
<span class="cstat-no" title="statement not covered" >                part.type = 'percentage';</span>
<span class="cstat-no" title="statement not covered" >                part.value = +RegExp.$1;</span>
            }
            // integer
            else <span class="cstat-no" title="statement not covered" >if (/^([+\-]?\d+)$/i.test(arr[i])) {</span>
<span class="cstat-no" title="statement not covered" >                    part.type = 'integer';</span>
<span class="cstat-no" title="statement not covered" >                    part.value = +RegExp.$1;</span>
                }
                // number
                else <span class="cstat-no" title="statement not covered" >if (/^([+\-]?[\d\.]+)$/i.test(arr[i])) {</span>
<span class="cstat-no" title="statement not covered" >                        part.type = 'number';</span>
<span class="cstat-no" title="statement not covered" >                        part.value = +RegExp.$1;</span>
                    }
                    // hexcolor
                    else <span class="cstat-no" title="statement not covered" >if (/^#([a-f0-9]{3,6})/i.test(arr[i])) {</span>
<span class="cstat-no" title="statement not covered" >                            part.type = 'color';</span>
<span class="cstat-no" title="statement not covered" >                            temp = RegExp.$1;</span>
<span class="cstat-no" title="statement not covered" >                            if (temp.length === 3) {</span>
<span class="cstat-no" title="statement not covered" >                                part.red = parseInt(temp.charAt(0) + temp.charAt(0), 16);</span>
<span class="cstat-no" title="statement not covered" >                                part.green = parseInt(temp.charAt(1) + temp.charAt(1), 16);</span>
<span class="cstat-no" title="statement not covered" >                                part.blue = parseInt(temp.charAt(2) + temp.charAt(2), 16);</span>
                            } else {
<span class="cstat-no" title="statement not covered" >                                part.red = parseInt(temp.substring(0, 2), 16);</span>
<span class="cstat-no" title="statement not covered" >                                part.green = parseInt(temp.substring(2, 4), 16);</span>
<span class="cstat-no" title="statement not covered" >                                part.blue = parseInt(temp.substring(4, 6), 16);</span>
                            }
                        }
                        // rgb() color with absolute numbers
                        else <span class="cstat-no" title="statement not covered" >if (/^rgb\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)/i.test(arr[i])) {</span>
<span class="cstat-no" title="statement not covered" >                                part.type = 'color';</span>
<span class="cstat-no" title="statement not covered" >                                part.red = +RegExp.$1;</span>
<span class="cstat-no" title="statement not covered" >                                part.green = +RegExp.$2;</span>
<span class="cstat-no" title="statement not covered" >                                part.blue = +RegExp.$3;</span>
                            }
                            // rgb() color with percentages
                            else <span class="cstat-no" title="statement not covered" >if (/^rgb\(\s*(\d+)%\s*,\s*(\d+)%\s*,\s*(\d+)%\s*\)/i.test(arr[i])) {</span>
<span class="cstat-no" title="statement not covered" >                                    part.type = 'color';</span>
<span class="cstat-no" title="statement not covered" >                                    part.red = +RegExp.$1 * 255 / 100;</span>
<span class="cstat-no" title="statement not covered" >                                    part.green = +RegExp.$2 * 255 / 100;</span>
<span class="cstat-no" title="statement not covered" >                                    part.blue = +RegExp.$3 * 255 / 100;</span>
                                }
                                // rgba() color with absolute numbers
                                else <span class="cstat-no" title="statement not covered" >if (/^rgba\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*,\s*([\d\.]+)\s*\)/i.test(arr[i])) {</span>
<span class="cstat-no" title="statement not covered" >                                        part.type = 'color';</span>
<span class="cstat-no" title="statement not covered" >                                        part.red = +RegExp.$1;</span>
<span class="cstat-no" title="statement not covered" >                                        part.green = +RegExp.$2;</span>
<span class="cstat-no" title="statement not covered" >                                        part.blue = +RegExp.$3;</span>
<span class="cstat-no" title="statement not covered" >                                        part.alpha = +RegExp.$4;</span>
                                    }
...
<span class="cstat-no" title="statement not covered" >                                            part.alpha = +RegExp.$4;</span>
                                        ...
                                        // hsl()
                                        else <span class="cstat-no" title="statement not covered" >if (/^hsl\(\s*(\d+)\s*,\s*(\d+)%\s*,\s*(\d+)%\s*\)/i.test(arr[i])) {</span>
<span class="cstat-no" title="statement not covered" >                                                part.type = 'color';</span>
<span class="cstat-no" title="statement not covered" >                                                part.hue = +RegExp.$1;</span>
<span class="cstat-no" title="statement not covered" >                                                part.saturation = +RegExp.$2 / 100;</span>
<span class="cstat-no" title="statement not covered" >                                                part.lightness = +RegExp.$3 / 100;</span>
                                            }
                                            // hsla() color with percentages
                                            else <span class="cstat-no" title="statement not covered" >if (/^hsla\(\s*(\d+)\s*,\s*(\d+)%\s*,\s*(\d+)%\s*,\s*([\d\.]+)\s*\)/i.test(arr[i])) {</span>
<span class="cstat-no" title="statement not covered" >                                                    part.type = 'color';</span>
<span class="cstat-no" title="statement not covered" >                                                    part.hue = +RegExp.$1;</span>
<span class="cstat-no" title="statement not covered" >                                                    part.saturation = +RegExp.$2 / 100;</span>
<span class="cstat-no" title="statement not covered" >                                                    part.lightness = +RegExp.$3 / 100;</span>
<span class="cstat-no" title="statement not covered" >                                                    part.alpha = +RegExp.$4;</span>
                                                ...
                                                // URI
                                                else <span class="cstat-no" title="statement not covered" >if (/^url\(["']?([^\)"']+)["']?\)/i.test(arr[i])) {</span>
<span class="cstat-no" title="statement not covered" >                                                        part.type = 'uri';</span>
<span class="cstat-no" title="statement not covered" >                                                        part.uri = RegExp.$1;</span>
                                                    } else <span class="cstat-no" title="statement not covered" >if (/^([^\(]+)\(/i.test(arr[i])) {</span>
<span class="cstat-no" title="statement not covered" >                                                        part.type = 'function';</span>
<span class="cstat-no" title="statement not covered" >                                                        part.name = RegExp.$1;</span>
<span class="cstat-no" title="statement not covered" >                                                        part.value = arr[i];</span>
                                                    }
                                                    // string
                                                    else <span class="cstat-no" title="statement not covered" >if (/^["'][^"']*["']/.test(arr[i])) {</span>
                                                            // eval('"Microsoft Yahei",') has error
<span class="cstat-no" title="statement not covered" >                                                            temp = arr[i].replace(/,$/g, '');</span>
<span class="cstat-no" title="statement not covered" >                                                            part.type = 'string';</span>
                                                            /* jshint evil: true */
                                                            /* eslint-disable fecs-no-eval, no-eval */
<span class="cstat-no" title="statement not covered" >                                                            part.value = eval(temp);</span>
                                                            /* eslint-enable fecs-no-eval, no-eval */
                                                        }
                                                        // named color
                                                        else <span class="cstat-no" title="statement not covered" >if (_colors2.default[arr[i].toLowerCase()]) {</span>
<span class="cstat-no" title="statement not covered" >                                                                part.type = 'color';</span>
<span class="cstat-no" title="statement not covered" >                                                                temp = _colors2.default[arr[i].toLowerCase()].substring(1);</span>
<span class="cstat-no" title="statement not covered" >                                                                part.red = parseInt(temp.substring(0, 2), 16);</span>
<span class="cstat-no" title="statement not covered" >                                                                part.green = parseInt(temp.substring(2, 4), 16);</span>
<span class="cstat-no" title="statement not covered" >                                                                part.blue = parseInt(temp.substring(4, 6), 16);</span>
                                                            } else <span class="cstat-no" title="statement not covered" >if (/^[\,\/]$/.test(arr[i])) {</span>
<span class="cstat-no" title="statement not covered" >                                                                part.type = 'operator';</span>
<span class="cstat-no" title="statement not covered" >                                                                part.value = arr[i];</span>
                                                            } else <span class="cstat-no" title="statement not covered" >if (/^[a-z\-_\u0080-\uFFFF][a-z0-9\-_\u0080-\uFFFF]*$/i.test(arr[i])) {</span>
<span class="cstat-no" title="statement not covered" >                                                                part.type = 'identifier';</span>
<span class="cstat-no" title="statement not covered" >                                                                part.value = arr[i];</span>
                                                            }
&nbsp;
<span class="cstat-no" title="statement not covered" >        parts.push(part);</span>
    }
&nbsp;
