...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-csshint/node_modules/csshint/lib/rule/require-before-space.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-csshint/node_modules/csshint/lib/rule/require-before-space.js</span></h1>
    <h2>
        
        Statements: <span class="metric">46.43% <small>(13 / 28)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">44.44% <small>(12 / 27)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-csshint/node_modules/csshint/lib/rule/</a> &#187; require-before-space.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >                if (rule.raws.between === '' &amp;&amp; realRuleVal.indexOf('{') !== -1) {</span>
...
<span class="cstat-no" title="statement not covered" >                    var col = source.start.column + rule.selector.length;</span>
