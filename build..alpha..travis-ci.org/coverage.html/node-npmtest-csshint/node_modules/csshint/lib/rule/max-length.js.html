...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-csshint/node_modules/csshint/lib/rule/max-length.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-csshint/node_modules/csshint/lib/rule/max-length.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-csshint/node_modules/csshint/lib/rule/</a> &#187; max-length.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            excludeLines = [];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            var MSG = 'Each line must not be greater than ' + opts.ruleVal + ' characters';</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                    excludeLines.push(decl.source.start.line);</span>
                }
            });
&nbsp;
<span class="cstat-no" title="statement not covered" >            var lines = css.source.input.css.split(/\n/);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            for (var i = 0, len = lines.length; i &lt; len; i++) {</span>
<span class="cstat-no" title="statement not covered" >                if (lines[i].length &gt; opts.ruleVal &amp;&amp; excludeLines.indexOf(i + 1) === -1) {</span>
