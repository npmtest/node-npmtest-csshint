...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-csshint/node_modules/csshint/lib/rule/unifying-color-case-sensitive.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-csshint/node_modules/csshint/lib/rule/unifying-color-case-sensitive.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-csshint/node_modules/csshint/lib/rule/</a> &#187; unifying-color-case-sensitive.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                var source = void 0;</span>
<span class="cstat-no" title="statement not covered" >                var line = void 0;</span>
<span class="cstat-no" title="statement not covered" >                var lineContent = void 0;</span>
<span class="cstat-no" title="statement not covered" >                var col = void 0;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                css.walkDecls(<span class="fstat-no" title="function not covered" >function (decl) {</span></span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                    var value = decl.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (!/#([a-fA-Z0-9]{3,6})/.test(value) // 排除非 hexColor</span>
                    || /^#([0-9]{6})/.test(value) // 排除 #000000 纯数字的情况
                    ) {
<span class="cstat-no" title="statement not covered" >                            return;</span>
                        }
&nbsp;
<span class="cstat-no" title="statement not covered" >                    var simpleColorStr = RegExp.$1;</span>
&nbsp;
                    // 当前这个颜色值里的字母全是小写 #fafafa
<span class="cstat-no" title="statement not covered" >                    if (/^([a-z0-9]{3,6})$/.test(simpleColorStr)) {</span>
<span class="cstat-no" title="statement not covered" >                        if (global.CSSHINT_HEXCOLOR_CASE_FLAG === undefined) {</span>
<span class="cstat-no" title="statement not covered" >                            global.CSSHINT_HEXCOLOR_CASE_FLAG = 0;</span>
                        }
&nbsp;
                        // 说明之前已经检测过的颜色值里面的字母应该是大写
<span class="cstat-no" title="statement not covered" >                        if (global.CSSHINT_HEXCOLOR_CASE_FLAG === 1) {</span>
<span class="cstat-no" title="statement not covered" >                            source = decl.source;</span>
<span class="cstat-no" title="statement not covered" >                            line = source.start.line;</span>
<span class="cstat-no" title="statement not covered" >                            lineContent = (0, _util.getLineContent)(line, source.input.css);</span>
<span class="cstat-no" title="statement not covered" >                            col = source.start.column + decl.prop.length + decl.raws.between.length;</span>
<span class="cstat-no" title="statement not covered" >                            var upperCaseMsg = MSG + ', Current project case is UpperCase.';</span>
<span class="cstat-no" title="statement not covered" >                            var upperCaseColorMsg = MSG + ', Current project case is ' + _chalk2.default.magenta('UpperCase.');</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                            global.CSSHINT_INVALID_ALL_COUNT++;</span>
                    ...
                    else <span class="cstat-no" title="statement not covered" >if (/^([A-Z0-9]{3,6})$/.test(simpleColorStr)) {</span>
<span class="cstat-no" title="statement not covered" >                            if (global.CSSHINT_HEXCOLOR_CASE_FLAG === undefined) {</span>
<span class="cstat-no" title="statement not covered" >                                global.CSSHINT_HEXCOLOR_CASE_FLAG = 1;</span>
                            }
                            // 说明之前已经检测过的颜色值里面的字母应该是大写
<span class="cstat-no" title="statement not covered" >                            if (global.CSSHINT_HEXCOLOR_CASE_FLAG === 0) {</span>
<span class="cstat-no" title="statement not covered" >                                source = decl.source;</span>
<span class="cstat-no" title="statement not covered" >                                line = source.start.line;</span>
<span class="cstat-no" title="statement not covered" >                                lineContent = (0, _util.getLineContent)(line, source.input.css);</span>
<span class="cstat-no" title="statement not covered" >                                col = source.start.column + decl.prop.length + decl.raws.between.length;</span>
<span class="cstat-no" title="statement not covered" >                                var lowerCaseMsg = MSG + ', Current project case is LowerCase.';</span>
<span class="cstat-no" title="statement not covered" >                                var lowerCaseColorMsg = MSG + ', Current project case is ' + _chalk2.default.magenta('LowerCase.');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                                result.warn(RULENAME, {</span>
                                    node: decl,
                                    ruleName: RULENAME,
...
<span class="cstat-no" title="statement not covered" >                                var str = MSG;</span>
<span class="cstat-no" title="statement not covered" >                                var colorStr = MSG;</span>
<span class="cstat-no" title="statement not covered" >                                if (global.CSSHINT_HEXCOLOR_CASE_FLAG === 0) {</span>
<span class="cstat-no" title="statement not covered" >                                    str += ', Current project case is LowerCase.';</span>
<span class="cstat-no" title="statement not covered" >                                    colorStr += ', Current project case is ' + _chalk2.default.magenta('LowerCase.');</span>
                                } else <span class="cstat-no" title="statement not covered" >if (global.CSSHINT_HEXCOLOR_CASE_FLAG === 1) {</span>
<span class="cstat-no" title="statement not covered" >                                    str += ', Current project case is UpperCase.';</span>
<span class="cstat-no" title="statement not covered" >                                    colorStr += ', Current project case is ' + _chalk2.default.magenta('UpperCase.');</span>
                                }
<span class="cstat-no" title="statement not covered" >                                source = decl.source;</span>
<span class="cstat-no" title="statement not covered" >                                line = source.start.line;</span>
<span class="cstat-no" title="statement not covered" >                                lineContent = (0, _util.getLineContent)(line, source.input.css);</span>
