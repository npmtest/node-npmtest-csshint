...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-csshint/node_modules/csshint/lib/rule/shorthand.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-csshint/node_modules/csshint/lib/rule/shorthand.js</span></h1>
    <h2>
        
        Statements: <span class="metric">33.82% <small>(23 / 68)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">15.38% <small>(4 / 26)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">25% <small>(2 / 8)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">32.84% <small>(22 / 67)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-csshint/node_modules/csshint/lib/rule/</a> &#187; shorthand.js</div>
</div>
<div class="body">
...
(function () {
    ...
    for (var prop in mapping) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (mapping.hasOwnProperty(prop)) {
 ...
 */
var getPropertyMsg = <span class="fstat-no" title="function not covered" >function getPropertyMsg(propertyStr, selector, replaceProperty) {</span>
...
<span class="cstat-no" title="statement not covered" >            if (realRuleVal.indexOf('color') &gt; -1) {</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                    var parts = _postcss2.default.list.space(decl.value);</span>
...
<span class="cstat-no" title="statement not covered" >                        if (PATTERN_COLOR.test(part)) {</span>
<span class="cstat-no" title="statement not covered" >                            var source = decl.source;</span>
<span class="cstat-no" title="statement not covered" >                            if (lineCache !== source.start.line) {</span>
<span class="cstat-no" title="statement not covered" >                                lineCache = source.start.line;</span>
...
<span class="cstat-no" title="statement not covered" >                                var col = source.start.column + decl.prop.length + decl.raws.between.length;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (realRuleVal.indexOf('property') &gt; -1) {</span>
...
<span class="cstat-no" title="statement not covered" >                        var nodes = rule.nodes,</span>
                            selector = rule.selector;
&nbsp;
<span class="cstat-no" title="statement not covered" >                        for (var i = 0, len = nodes.length; i &lt; len; i++) {</span>
<span class="cstat-no" title="statement not covered" >                            var decl = nodes[i];</span>
<span class="cstat-no" title="statement not covered" >                            if (decl.type === 'decl') {</span>
<span class="cstat-no" title="statement not covered" >                                var prop = decl.prop;</span>
<span class="cstat-no" title="statement not covered" >                                var v = propertiesToCheck[prop];</span>
<span class="cstat-no" title="statement not covered" >                                if (!v) {</span>
<span class="cstat-no" title="statement not covered" >                                    continue;</span>
                                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                                if (!tmp[v]) {</span>
<span class="cstat-no" title="statement not covered" >                                    tmp[v] = 1;</span>
                                } else {
<span class="cstat-no" title="statement not covered" >                                    tmp[v] += 1;</span>
                                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                                if (tmp[v] &gt;= mapping[v].length) {</span>
<span class="cstat-no" title="statement not covered" >                                    var source = decl.source;</span>
<span class="cstat-no" title="statement not covered" >                                    var line = source.start.line;</span>
<span class="cstat-no" title="statement not covered" >                                    var col = source.start.column;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                                    var msg = getPropertyMsg(mapping[v].join(', '), selector, v);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                                    result.warn(RULENAME, {</span>
                                        node: decl,
                                        ruleName: RULENAME,
