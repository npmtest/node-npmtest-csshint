...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-csshint/node_modules/csshint/lib/rule/fallback-colors.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-csshint/node_modules/csshint/lib/rule/fallback-colors.js</span></h1>
    <h2>
        
        Statements: <span class="metric">32.61% <small>(15 / 46)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">13.04% <small>(3 / 23)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-csshint/node_modules/csshint/lib/rule/</a> &#187; fallback-colors.js</div>
</div>
<div class="body">
 ...
 */
var declHandler = <span class="fstat-no" title="function not covered" >function declHandler(decl, result) {</span>
<span class="cstat-no" title="statement not covered" >    var prop = decl.prop;</span>
<span class="cstat-no" title="statement not covered" >    var value = (0, _util.getPropertyValue)(decl.value);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var len = value.length;</span>
<span class="cstat-no" title="statement not covered" >    var i = 0;</span>
<span class="cstat-no" title="statement not covered" >    var colorType = '';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    while (i &lt; len) {</span>
<span class="cstat-no" title="statement not covered" >        if (value[i].type === 'color') {</span>
<span class="cstat-no" title="statement not covered" >            if ('alpha' in value[i] || 'hue' in value[i]) {</span>
<span class="cstat-no" title="statement not covered" >                if (/([^\)]+)\(/.test(value[i].text)) {</span>
<span class="cstat-no" title="statement not covered" >                    colorType = RegExp.$1.toUpperCase();</span>
                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (!lastProperty || lastProperty.prop !== prop || lastProperty.colorType !== 'compat') {</span>
...
<span class="cstat-no" title="statement not covered" >                    var str = 'Fallback ' + prop + ' (hex or RGB) should precede ' + colorType + ' ' + prop;</span>
<span class="cstat-no" title="statement not covered" >                    var colorStr = 'Fallback ' + _chalk2.default.magenta(prop) + ' (hex or RGB) should precede ' + _chalk2.default.magenta(colorType) + ' ' + _chalk2.default.magenta(prop);</span>
...
<span class="cstat-no" title="statement not covered" >                decl.colorType = 'compat';</span>
            }
        }
...
<span class="cstat-no" title="statement not covered" >            lastProperty = null;</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (propertiesToCheck[decl.prop]) {</span>
<span class="cstat-no" title="statement not covered" >                    declHandler(decl, result);</span>
                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                lastProperty = decl;</span>
            });
        });
    };
});
