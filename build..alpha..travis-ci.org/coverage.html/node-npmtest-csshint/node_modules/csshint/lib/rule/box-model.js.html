...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-csshint/node_modules/csshint/lib/rule/box-model.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-csshint/node_modules/csshint/lib/rule/box-model.js</span></h1>
    <h2>
        
        Statements: <span class="metric">29.51% <small>(18 / 61)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">6.25% <small>(3 / 48)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">14.29% <small>(1 / 7)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">28.33% <small>(17 / 60)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-csshint/node_modules/csshint/lib/rule/</a> &#187; box-model.js</div>
</div>
<div class="body">
 ...
 * @return {Object} 错误信息
 */
var getWidthMsg = <span class="fstat-no" title="function not covered" >function getWidthMsg(prop) {</span>
 ...
 * @return {Object} 错误信息
 */
var getHeightMsg = <span class="fstat-no" title="function not covered" >function getHeightMsg(prop) {</span>
<span class="cstat-no" title="statement not covered" >    return {</span>
...
<span class="cstat-no" title="statement not covered" >        if (!opts.ruleVal) {</span>
<span class="cstat-no" title="statement not covered" >            return;</span>
        }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            boxSizing = false;</span>
&nbsp;
...
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (heightProperties[prop] || widthProperties[prop]) {</span>
<span class="cstat-no" title="statement not covered" >                    if (!/^0\S*$/.test(value) &amp;&amp; !(prop === 'border' &amp;&amp; value.toString() === 'none')) {</span>
<span class="cstat-no" title="statement not covered" >                        properties[prop] = decl;</span>
                    }
                } else {
<span class="cstat-no" title="statement not covered" >                    if (/^(width|height)/i.test(prop) &amp;&amp; /^(length|percentage)/.test((0, _util.getPropertyValue)(value)[0].type)) {</span>
<span class="cstat-no" title="statement not covered" >                        properties[prop] = 1;</span>
                    } else <span class="cstat-no" title="statement not covered" >if (prop === 'box-sizing') {</span>
<span class="cstat-no" title="statement not covered" >                        boxSizing = true;</span>
                    }
                }
            });
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (boxSizing) {</span>
<span class="cstat-no" title="statement not covered" >                return;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (properties.height) {</span>
                /* eslint-disable fecs-use-for-of, fecs-valid-map-set */
<span class="cstat-no" title="statement not covered" >                for (var hp in heightProperties) {</span>
<span class="cstat-no" title="statement not covered" >                    if (heightProperties.hasOwnProperty(hp) &amp;&amp; properties[hp]) {</span>
<span class="cstat-no" title="statement not covered" >                        var hpValue = properties[hp].value;</span>
<span class="cstat-no" title="statement not covered" >                        var hpValueParts = _postcss2.default.list.space(hpValue);</span>
                        // 排除 padding: 0 10px; 这样的情况
<span class="cstat-no" title="statement not covered" >                        if (!(hp === 'padding' &amp;&amp; hpValueParts.length === 2 &amp;&amp; parseInt(hpValueParts[0], 10) === 0)) {</span>
<span class="cstat-no" title="statement not covered" >                            var hSource = properties[hp].source;</span>
<span class="cstat-no" title="statement not covered" >                            var hLine = hSource.start.line;</span>
<span class="cstat-no" title="statement not covered" >                            var hMsg = getHeightMsg(hp);</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (properties.width) {</span>
                /* eslint-disable fecs-use-for-of, fecs-valid-map-set */
<span class="cstat-no" title="statement not covered" >                for (var wp in widthProperties) {</span>
<span class="cstat-no" title="statement not covered" >                    if (widthProperties.hasOwnProperty(wp) &amp;&amp; properties[wp]) {</span>
<span class="cstat-no" title="statement not covered" >                        var wpValue = properties[wp].value;</span>
<span class="cstat-no" title="statement not covered" >                        var wpValueParts = _postcss2.default.list.space(wpValue);</span>
                        // 排除 padding: 10px 0; 这样的情况
<span class="cstat-no" title="statement not covered" >                        if (!(wp === 'padding' &amp;&amp; wpValueParts.length === 2 &amp;&amp; parseInt(wpValueParts[1], 10) === 0)) {</span>
<span class="cstat-no" title="statement not covered" >                            var wSource = properties[wp].source;</span>
<span class="cstat-no" title="statement not covered" >                            var wLine = wSource.start.line;</span>
<span class="cstat-no" title="statement not covered" >                            var wMsg = getWidthMsg(wp);</span>
<span class="cstat-no" title="statement not covered" >                            result.warn(RULENAME, {</span>
                                node: properties[wp],
                                ruleName: RULENAME,
                                line: wLine,
