...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-csshint/node_modules/csshint/lib/rule/box-sizing.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-csshint/node_modules/csshint/lib/rule/box-sizing.js</span></h1>
    <h2>
        
        Statements: <span class="metric">44.44% <small>(12 / 27)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">42.31% <small>(11 / 26)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-csshint/node_modules/csshint/lib/rule/</a> &#187; box-sizing.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >                if (prop === 'box-sizing') {</span>
...
<span class="cstat-no" title="statement not covered" >                    result.warn(RULENAME, {</span>
                        ...
                        col: col,
                        message: MSG,
                        colorMessage: '`' + lineContent.replace(prop, _chalk2.default.magenta(prop)) + '` ' + _chalk2.default.grey(MSG)
                    });
