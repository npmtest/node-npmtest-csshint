...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-csshint/node_modules/csshint/lib/rule/require-doublequotes.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-csshint/node_modules/csshint/lib/rule/require-doublequotes.js</span></h1>
    <h2>
        
        Statements: <span class="metric">25.4% <small>(16 / 63)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-csshint/node_modules/csshint/lib/rule/</a> &#187; require-doublequotes.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >        var ruleVal = opts.ruleVal;</span>
<span class="cstat-no" title="statement not covered" >        var realRuleVal = [];</span>
<span class="cstat-no" title="statement not covered" >        arrayProto.push[Array.isArray(ruleVal) ? 'apply' : 'call'](realRuleVal, ruleVal);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (realRuleVal.length) {</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (realRuleVal.indexOf('attr-selector') &gt; -1) {</span>
<span class="cstat-no" title="statement not covered" >                (<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >                    var invalidRules = [];</span>
...
<span class="cstat-no" title="statement not covered" >                        var cleanSelector = rule.selector.replace(/\(.*\)/, '').replace(/:root/, '');</span>
<span class="cstat-no" title="statement not covered" >                        var match = cleanSelector.match(PATTERN_ATTR_SELECTOR);</span>
<span class="cstat-no" title="statement not covered" >                        if (match &amp;&amp; match.length) {</span>
                            // 判处掉没有 = 的情况，没有 = 就说明就是属性选择器，例如 input[data-test]
<span class="cstat-no" title="statement not covered" >                            if (match[0].indexOf('=') &gt; -1) {</span>
<span class="cstat-no" title="statement not covered" >                                var quoteMatch = match[0].match(/.*=((['"]).*\2).*/);</span>
<span class="cstat-no" title="statement not covered" >                                if (quoteMatch) {</span>
<span class="cstat-no" title="statement not covered" >                                    if (quoteMatch[2] !== '"') {</span>
<span class="cstat-no" title="statement not covered" >                                        invalidRules.push(rule);</span>
                                    }
                                } else {
<span class="cstat-no" title="statement not covered" >                                    invalidRules.push(rule);</span>
                                }
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                    invalidRules.forEach(<span class="fstat-no" title="function not covered" >function (invalidRule) {</span></span>
<span class="cstat-no" title="statement not covered" >                        var source = invalidRule.source,</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (realRuleVal.indexOf('text-content') &gt; -1) {</span>
<span class="cstat-no" title="statement not covered" >                (<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >                    var invalidDecls = [];</span>
...
<span class="cstat-no" title="statement not covered" >                        var parts = _postcss2.default.list.comma(decl.value);</span>
<span class="cstat-no" title="statement not covered" >                        for (var i = 0, len = parts.length; i &lt; len; i++) {</span>
                            // 排除掉 uri 的情况，例如
...
<span class="cstat-no" title="statement not covered" >                            if (!PATTERN_URI.test(parts[i])) {</span>
<span class="cstat-no" title="statement not covered" >                                var quoteMatch = parts[i].match(/.*(['"]).*\1/i);</span>
<span class="cstat-no" title="statement not covered" >                                if (quoteMatch) {</span>
<span class="cstat-no" title="statement not covered" >                                    if (quoteMatch[1] !== '"') {</span>
<span class="cstat-no" title="statement not covered" >                                        invalidDecls.push(decl);</span>
                                    }
                                }
                            }
                        }
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                    invalidDecls.forEach(<span class="fstat-no" title="function not covered" >function (invalidDecl) {</span></span>
<span class="cstat-no" title="statement not covered" >                        var source = invalidDecl.source;</span>
<span class="cstat-no" title="statement not covered" >                        var line = source.start.line;</span>
<span class="cstat-no" title="statement not covered" >                        var lineContent = (0, _util.getLineContent)(line, source.input.css);</span>
<span class="cstat-no" title="statement not covered" >                        var col = source.start.column + invalidDecl.prop.length + invalidDecl.raws.between.length;</span>
<span class="cstat-no" title="statement not covered" >                        result.warn(RULENAME, {</span>
                            node: invalidDecl,
                            ruleName: RULENAME,
