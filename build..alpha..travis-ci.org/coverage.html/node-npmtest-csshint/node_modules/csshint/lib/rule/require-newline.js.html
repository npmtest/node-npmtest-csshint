...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-csshint/node_modules/csshint/lib/rule/require-newline.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-csshint/node_modules/csshint/lib/rule/require-newline.js</span></h1>
    <h2>
        
        Statements: <span class="metric">23.94% <small>(17 / 71)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">23.88% <small>(16 / 67)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-csshint/node_modules/csshint/lib/rule/</a> &#187; require-newline.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (realRuleVal.indexOf('selector') &gt; -1) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                        var selector = rule.selector;</span>
<span class="cstat-no" title="statement not covered" >                        if (PATTERN_NOTLF.test(selector)) {</span>
<span class="cstat-no" title="statement not covered" >                            source = rule.source;</span>
...
<span class="cstat-no" title="statement not covered" >                            col = source.start.column;</span>
                            // 如果是 `p, i, \n.cc` 这样的选择器，那么高亮就应该把后面的 `\n.cc` 去掉
                            // 直接用 lineContent 来匹配 `p, i, \n.cc` 无法高亮
<span class="cstat-no" title="statement not covered" >                            var colorStr = selector.replace(/\n.*/, '');</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (realRuleVal.indexOf('media-query-condition') &gt; -1) {</span>
<span class="cstat-no" title="statement not covered" >                    if (global.CSSHINT_INVALID_ALL_COUNT &gt;= opts.maxError) {</span>
<span class="cstat-no" title="statement not covered" >                        return {</span>
                            v: void 0
                        };
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                    css.walkAtRules(<span class="fstat-no" title="function not covered" >function (atRule) {</span></span>
<span class="cstat-no" title="statement not covered" >                        if (atRule.name !== 'media') {</span>
<span class="cstat-no" title="statement not covered" >                            return;</span>
                        }
<span class="cstat-no" title="statement not covered" >                        var params = atRule.params;</span>
<span class="cstat-no" title="statement not covered" >                        if (PATTERN_NOTLF.test(params)) {</span>
<span class="cstat-no" title="statement not covered" >                            source = atRule.source;</span>
<span class="cstat-no" title="statement not covered" >                            line = source.start.line;</span>
<span class="cstat-no" title="statement not covered" >                            lineContent = (0, _util.getLineContent)(line, source.input.css);</span>
<span class="cstat-no" title="statement not covered" >                            col = source.start.column;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                            var colorStr = params.replace(/\n.*/, '');</span>
<span class="cstat-no" title="statement not covered" >                            result.warn(RULENAME, {</span>
                                node: atRule,
                                ruleName: RULENAME,
...
<span class="cstat-no" title="statement not covered" >                        if (before.indexOf('\n') === -1) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            if ((typeof _ret === 'undefined' ? 'undefined' : _typeof(_ret)) === "object") <span class="cstat-no" title="statement not covered" >return _ret.v;</span></span>
        }
    };
});
