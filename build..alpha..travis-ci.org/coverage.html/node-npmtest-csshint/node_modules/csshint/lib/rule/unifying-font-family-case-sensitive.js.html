...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-csshint/node_modules/csshint/lib/rule/unifying-font-family-case-sensitive.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-csshint/node_modules/csshint/lib/rule/unifying-font-family-case-sensitive.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-csshint/node_modules/csshint/lib/rule/</a> &#187; unifying-font-family-case-sensitive.js</div>
</div>
<div class="body">
 ...
 * @return {Object} 错误信息
 */
var getMsg = <span class="fstat-no" title="function not covered" >function getMsg(curFontFamily, projFontFamily) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (prop === 'font-family') {</span>
...
<span class="cstat-no" title="statement not covered" >                    var part = parts[i].replace(/['",]/g, '');</span>
<span class="cstat-no" title="statement not covered" >                    var partLowerCase = part.toLowerCase();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (!global.CSSHINT_FONTFAMILY_CASE_FLAG[partLowerCase]) {</span>
<span class="cstat-no" title="statement not covered" >                        global.CSSHINT_FONTFAMILY_CASE_FLAG[partLowerCase] = part;</span>
                    } else {
<span class="cstat-no" title="statement not covered" >                        if (global.CSSHINT_FONTFAMILY_CASE_FLAG[partLowerCase] !== part) {</span>
...
<span class="cstat-no" title="statement not covered" >                            var col = lineContent.indexOf(part) + 1;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                            var m = getMsg(part, global.CSSHINT_FONTFAMILY_CASE_FLAG[partLowerCase]);</span>
&nbsp;
