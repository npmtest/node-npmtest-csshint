...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-csshint/node_modules/csshint/lib/rule/always-semicolon.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-csshint/node_modules/csshint/lib/rule/always-semicolon.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-csshint/node_modules/csshint/lib/rule/</a> &#187; always-semicolon.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (rule.raws.semicolon) {</span>
<span class="cstat-no" title="statement not covered" >                return;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            var lastProp = rule.nodes[rule.nodes.length - 1];</span>
<span class="cstat-no" title="statement not covered" >            if (lastProp &amp;&amp; lastProp.type !== 'comment') {</span>
<span class="cstat-no" title="statement not covered" >                var source = lastProp.source;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                var value = lastProp.important ? lastProp.value + (lastProp.important ? lastProp.important : ' !important') : lastProp.value;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                var colorStr = lastProp.prop + lastProp.raws.between + value;</span>
<span class="cstat-no" title="statement not covered" >                var col = source.start.column + colorStr.length;</span>
&nbsp;
