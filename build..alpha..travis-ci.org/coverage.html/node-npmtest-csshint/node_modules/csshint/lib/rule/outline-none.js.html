...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-csshint/node_modules/csshint/lib/rule/outline-none.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-csshint/node_modules/csshint/lib/rule/outline-none.js</span></h1>
    <h2>
        
        Statements: <span class="metric">33.33% <small>(14 / 42)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">12% <small>(3 / 25)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">20% <small>(1 / 5)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">31.71% <small>(13 / 41)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-csshint/node_modules/csshint/lib/rule/</a> &#187; outline-none.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >                lastRule = {</span>
                    rule: rule,
                    selector: selector,
                    propCount: 0,
                    outline: false
...
<span class="cstat-no" title="statement not covered" >                lastRule = null;</span>
            }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                var prop = decl.prop,</span>
                    value = decl.value;
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (lastRule) {</span>
<span class="cstat-no" title="statement not covered" >                    lastRule.propCount++;</span>
<span class="cstat-no" title="statement not covered" >                    if (prop === 'outline' &amp;&amp; (value === 'none' || value.toString() === '0')) {</span>
<span class="cstat-no" title="statement not covered" >                        lastRule.outline = true;</span>
                    }
                }
            });
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (lastRule) {</span>
<span class="cstat-no" title="statement not covered" >                if (lastRule.outline) {</span>
<span class="cstat-no" title="statement not covered" >                    var source = lastRule.rule.source;</span>
...
<span class="cstat-no" title="statement not covered" >                    if (lastRule.selector.toLowerCase().indexOf(':focus') === -1) {</span>
...
<span class="cstat-no" title="statement not covered" >                        global.CSSHINT_INVALID_ALL_COUNT++;</span>
                    } else <span class="cstat-no" title="statement not covered" >if (lastRule.propCount === 1) {</span>
<span class="cstat-no" title="statement not covered" >                        result.warn(RULENAME, {</span>
                            node: lastRule.rule,
                            ruleName: RULENAME,
                            line: line,
