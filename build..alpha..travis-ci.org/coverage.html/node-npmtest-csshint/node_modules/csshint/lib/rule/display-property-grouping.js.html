...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-csshint/node_modules/csshint/lib/rule/display-property-grouping.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-csshint/node_modules/csshint/lib/rule/display-property-grouping.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-csshint/node_modules/csshint/lib/rule/</a> &#187; display-property-grouping.js</div>
</div>
<div class="body">
 ...
 */
var addWarn = <span class="fstat-no" title="function not covered" >function addWarn(result, prop, display, msg) {</span>
<span class="cstat-no" title="statement not covered" >    var decl = properties[prop];</span>
<span class="cstat-no" title="statement not covered" >    if (decl) {</span>
<span class="cstat-no" title="statement not covered" >        if (typeof propertiesToCheck[prop] !== 'string' || decl.value.toLowerCase() !== propertiesToCheck[prop]) {</span>
<span class="cstat-no" title="statement not covered" >            var source = decl.source;</span>
...
<span class="cstat-no" title="statement not covered" >                str = msg + ' can\'t be used with display: `' + display + '`';</span>
<span class="cstat-no" title="statement not covered" >                colorStr = msg + ' can\'t be used with display: `' + _chalk2.default.magenta(display) + '`';</span>
            } else {
<span class="cstat-no" title="statement not covered" >                str = '`' + prop + '` can\'t be used with display: `' + display + '`';</span>
<span class="cstat-no" title="statement not covered" >                colorStr = '' + '`' + _chalk2.default.magenta(prop) + '` can\'t be used with display: `' + _chalk2.default.magenta(display) + '`';</span>
            }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                if (propertiesToCheck[prop]) {</span>
<span class="cstat-no" title="statement not covered" >                    properties[prop] = decl;</span>
                }
            });
&nbsp;
<span class="cstat-no" title="statement not covered" >            var display = properties.display ? properties.display.value : null;</span>
<span class="cstat-no" title="statement not covered" >            if (!display) {</span>
<span class="cstat-no" title="statement not covered" >                return;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            switch (display) {</span>
                // height, width, margin-top, margin-bottom, float should not be used with inline
                case 'inline':
<span class="cstat-no" title="statement not covered" >                    addWarn(result, 'height', display);</span>
<span class="cstat-no" title="statement not covered" >                    addWarn(result, 'width', display);</span>
<span class="cstat-no" title="statement not covered" >                    addWarn(result, 'margin', display);</span>
<span class="cstat-no" title="statement not covered" >                    addWarn(result, 'margin-top', display);</span>
<span class="cstat-no" title="statement not covered" >                    addWarn(result, 'margin-bottom', display);</span>
<span class="cstat-no" title="statement not covered" >                    addWarn(result, 'float', display, 'display:inline has no effect on floated elements ' + '(but may be used to fix the IE6 double-margin bug).');</span>
<span class="cstat-no" title="statement not covered" >                    break;</span>
                // vertical-align should not be used with block
                case 'block':
<span class="cstat-no" title="statement not covered" >                    addWarn(result, 'vertical-align', display);</span>
<span class="cstat-no" title="statement not covered" >                    break;</span>
                // float should not be used with inline-block
                case 'inline-block':
<span class="cstat-no" title="statement not covered" >                    addWarn(result, 'float', display);</span>
<span class="cstat-no" title="statement not covered" >                    break;</span>
                // margin, float should not be used with table
                default:
<span class="cstat-no" title="statement not covered" >                    if (display.indexOf('table-') === 0) {</span>
<span class="cstat-no" title="statement not covered" >                        addWarn(result, 'margin', display);</span>
<span class="cstat-no" title="statement not covered" >                        addWarn(result, 'margin-left', display);</span>
<span class="cstat-no" title="statement not covered" >                        addWarn(result, 'margin-right', display);</span>
<span class="cstat-no" title="statement not covered" >                        addWarn(result, 'margin-top', display);</span>
<span class="cstat-no" title="statement not covered" >                        addWarn(result, 'margin-bottom', display);</span>
<span class="cstat-no" title="statement not covered" >                        addWarn(result, 'float', display);</span>
                    }
