...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-csshint/node_modules/csshint/lib/rule/universal-selector.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-csshint/node_modules/csshint/lib/rule/universal-selector.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-csshint/node_modules/csshint/lib/rule/</a> &#187; universal-selector.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >                var l = segments.length;</span>
<span class="cstat-no" title="statement not covered" >                if (l) {</span>
<span class="cstat-no" title="statement not covered" >                    if (segments[l - 1] === '*') {</span>
<span class="cstat-no" title="statement not covered" >                        if (selectorInGroup.slice(0, 1) === '\n') {</span>
<span class="cstat-no" title="statement not covered" >                            line = line + 1;</span>
<span class="cstat-no" title="statement not covered" >                            lineContent = (0, _util.getLineContent)(line, source.input.css);</span>
                        }
<span class="cstat-no" title="statement not covered" >                        var col = lineContent.indexOf(segments[l - 1]) + 1;</span>
