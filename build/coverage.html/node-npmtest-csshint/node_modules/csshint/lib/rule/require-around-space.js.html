...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-csshint/node_modules/csshint/lib/rule/require-around-space.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-csshint/node_modules/csshint/lib/rule/require-around-space.js</span></h1>
    <h2>
        
        Statements: <span class="metric">24.56% <small>(14 / 57)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-csshint/node_modules/csshint/lib/rule/</a> &#187; require-around-space.js</div>
</div>
<div class="body">
 ...
 * @return {string} 错误信息
 */
var getMsg = <span class="fstat-no" title="function not covered" >function getMsg(combinator) {</span>
<span class="cstat-no" title="statement not covered" >    return '' + 'Around the `' + combinator + '` selector will keep a space';</span>
};
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                    selector = selector.replace(/\([\s\S]*?\)/g, '');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    var segments = selector.split(PATTERN_COMBINATORS);</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                        var lastChar = segment.slice(-1);</span>
<span class="cstat-no" title="statement not covered" >                        var firstChar = segment.slice(0, 1);</span>
<span class="cstat-no" title="statement not covered" >                        if (segment) {</span>
<span class="cstat-no" title="statement not covered" >                            segment = (0, _util.trim)(segment);</span>
<span class="cstat-no" title="statement not covered" >                            if (realRuleVal.indexOf(segment) &lt;= -1) {</span>
<span class="cstat-no" title="statement not covered" >                                continue;</span>
                            }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                                    invalidList.push({</span>
                                        invalidChar: segment,
                                        rule: rule
                                    });
<span class="cstat-no" title="statement not covered" >                                    continue;</span>
                                }
                            } else <span class="cstat-no" title="statement not covered" >if (i === len - 1) {</span>
...
<span class="cstat-no" title="statement not covered" >                                if (lastChar !== ' ' || firstChar !== ' ') {</span>
<span class="cstat-no" title="statement not covered" >                                    invalidList.push({</span>
                                        invalidChar: segment,
                                        rule: rule
                                    });
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                invalidList.forEach(<span class="fstat-no" title="function not covered" >function (invalidRule) {</span></span>
<span class="cstat-no" title="statement not covered" >                    var invalidChar = invalidRule.invalidChar,</span>
                        rule = invalidRule.rule;
&nbsp;
<span class="cstat-no" title="statement not covered" >                    var msg = getMsg(invalidRule.invalidChar);</span>
<span class="cstat-no" title="statement not covered" >                    var source = rule.source;</span>
...
<span class="cstat-no" title="statement not covered" >                    var col = lineContent.indexOf(invalidChar);</span>
