...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-csshint/node_modules/csshint/lib/rule/max-selector-nesting-level.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-csshint/node_modules/csshint/lib/rule/max-selector-nesting-level.js</span></h1>
    <h2>
        
        Statements: <span class="metric">36.11% <small>(13 / 36)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-csshint/node_modules/csshint/lib/rule/</a> &#187; max-selector-nesting-level.js</div>
</div>
<div class="body">
 ...
 * @return {string} 错误信息
 */
var getMsg = <span class="fstat-no" title="function not covered" >function getMsg(level) {</span>
<span class="cstat-no" title="statement not covered" >    return '' + 'A nested hierarchy selector should be no more than ' + level + ' levels';</span>
};
&nbsp;
/**
 * 具体的检测逻辑
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (!opts.ruleVal || isNaN(opts.ruleVal)) {</span>
<span class="cstat-no" title="statement not covered" >            return;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        var msg = getMsg(opts.ruleVal);</span>
&nbsp;
...
&nbsp;
                // 去掉 attr 选择器
<span class="cstat-no" title="statement not covered" >                selectorInGroup = selectorInGroup.replace(/\[.+?\](?::[^\s&gt;+~\.#\[]+)?/g, '');</span>
&nbsp;
                // 先去掉 selectorInGroup 的前后空格，如果有空格，那么 segments 的第一个 item 是空，但是会增加 length
<span class="cstat-no" title="statement not covered" >                var segments = selectorInGroup.replace(/^[\s\xa0\u3000]+|[\u3000\xa0\s]+$/g, '').split(PATTERN_COMBINATORS);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (segments.length &gt; opts.ruleVal) {</span>
...
<span class="cstat-no" title="statement not covered" >                    var line = source.start.line + extraLine;</span>
<span class="cstat-no" title="statement not covered" >                    var lineContent = (0, _util.getLineContent)(line, source.input.css);</span>
&nbsp;
                    // 这里去掉 \n 是为了变色
<span class="cstat-no" title="statement not covered" >                    selectorInGroup = selectorInGroup.replace(/\n/g, '');</span>
&nbsp;
