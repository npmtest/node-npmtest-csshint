...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-csshint/node_modules/csshint/lib/rule/omit-protocol-in-url.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-csshint/node_modules/csshint/lib/rule/omit-protocol-in-url.js</span></h1>
    <h2>
        
        Statements: <span class="metric">45.16% <small>(14 / 31)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-csshint/node_modules/csshint/lib/rule/</a> &#187; omit-protocol-in-url.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >                var matchProtocol = null;</span>
&nbsp;
                /* eslint-disable no-extra-boolean-cast */
<span class="cstat-no" title="statement not covered" >                while (!!(match = PATTERN_URL.exec(value))) {</span>
<span class="cstat-no" title="statement not covered" >                    var url = match[2];</span>
&nbsp;
                    // decl.value 相对于 lineContent 的 index
<span class="cstat-no" title="statement not covered" >                    var valueIndex = lineContent.indexOf(decl.value);</span>
&nbsp;
                    // 相对于 decl.value 的 index
<span class="cstat-no" title="statement not covered" >                    var index = valueIndex + match.input.indexOf(url);</span>
<span class="cstat-no" title="statement not covered" >                    while (!!(matchProtocol = PATTERN_PROTOCOL.exec(url))) {</span>
