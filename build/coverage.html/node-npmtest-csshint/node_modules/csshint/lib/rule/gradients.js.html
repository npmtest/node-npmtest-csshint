...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-csshint/node_modules/csshint/lib/rule/gradients.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-csshint/node_modules/csshint/lib/rule/gradients.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-csshint/node_modules/csshint/lib/rule/</a> &#187; gradients.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            gradients = {</span>
                moz: 0,
                webkit: 0,
                oldWebkit: 0,
                o: 0
...
<span class="cstat-no" title="statement not covered" >                if (/\-(moz|o|webkit)(?:\-(?:linear|radial))\-gradient/i.test(value)) {</span>
<span class="cstat-no" title="statement not covered" >                    gradients[RegExp.$1] = 1;</span>
                } else <span class="cstat-no" title="statement not covered" >if (/\-webkit\-gradient/i.test(value)) {</span>
<span class="cstat-no" title="statement not covered" >                    gradients.oldWebkit = 1;</span>
                }
            });
&nbsp;
<span class="cstat-no" title="statement not covered" >            var missing = [];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!gradients.moz) {</span>
<span class="cstat-no" title="statement not covered" >                missing.push('Firefox 3.6+: -moz-linear-gradient');</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!gradients.webkit) {</span>
<span class="cstat-no" title="statement not covered" >                missing.push('Webkit (Safari 5+, Chrome): -webkit-linear-gradient');</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!gradients.oldWebkit) {</span>
<span class="cstat-no" title="statement not covered" >                missing.push('Old Webkit (Safari 4+, Chrome): -webkit-gradient');</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (!gradients.o) {</span>
<span class="cstat-no" title="statement not covered" >                missing.push('Opera 11.1+: -o-linear-gradient');</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (missing.length &amp;&amp; missing.length &lt; 4) {</span>
...
<span class="cstat-no" title="statement not covered" >                var str = MSG + missing.join(', ');</span>
