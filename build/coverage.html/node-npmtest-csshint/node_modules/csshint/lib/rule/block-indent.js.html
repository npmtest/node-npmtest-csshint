...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-csshint/node_modules/csshint/lib/rule/block-indent.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-csshint/node_modules/csshint/lib/rule/block-indent.js</span></h1>
    <h2>
        
        Statements: <span class="metric">15.7% <small>(19 / 121)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">5.36% <small>(3 / 56)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">8.33% <small>(1 / 12)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">15% <small>(18 / 120)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-csshint/node_modules/csshint/lib/rule/</a> &#187; block-indent.js</div>
</div>
<div class="body">
 ...
 * @return {string} 错误信息
 */
var getMsg = <span class="fstat-no" title="function not covered" >function getMsg(curIndentStr, neededIndentStr) {</span>
<span class="cstat-no" title="statement not covered" >    return '' + 'Bad indentation, Expected `' + neededIndentStr.length + '` but saw `' + curIndentStr.length + '`';</span>
};
&nbsp;
/**
 ...
 * @return {boolean} 结果
 */
var isValidVendorProp = <span class="fstat-no" title="function not covered" >function isValidVendorProp(decl) {</span>
<span class="cstat-no" title="statement not covered" >    var prop = decl.prop;</span>
<span class="cstat-no" title="statement not covered" >    var standardProperty = prop.replace(/^\-(webkit|moz|ms|o)\-/g, '');</span>
    // 标准模式在 prefixList 中，那么如果 propertyName 不在 prefixList 中
    // 即这个属性用错了，例如 -o-animation
<span class="cstat-no" title="statement not covered" >    if (prefixList.indexOf(standardProperty) &gt; -1) {</span>
<span class="cstat-no" title="statement not covered" >        if (prefixList.indexOf(prop) &lt;= -1) {</span>
 ...
 */
var addWarn = <span class="fstat-no" title="function not covered" >function addWarn(node, result, msg, hackPrefixChar) {</span>
<span class="cstat-no" title="statement not covered" >    var source = node.source;</span>
<span class="cstat-no" title="statement not covered" >    var line = source.start.line;</span>
<span class="cstat-no" title="statement not covered" >    if (lineCache !== line) {</span>
<span class="cstat-no" title="statement not covered" >        lineCache = line;</span>
<span class="cstat-no" title="statement not covered" >        var col = source.start.column;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var lineContent = (0, _util.getLineContent)(line, source.input.css) || '';</span>
<span class="cstat-no" title="statement not covered" >        var colorStr = '';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (node.selector) {</span>
<span class="cstat-no" title="statement not covered" >            colorStr = node.selector;</span>
        } else <span class="cstat-no" title="statement not covered" >if (node.type === 'atrule') {</span>
<span class="cstat-no" title="statement not covered" >            colorStr = lineContent;</span>
        } else {
<span class="cstat-no" title="statement not covered" >            colorStr = (hackPrefixChar || '') + node.prop + node.raws.between + node.value;</span>
<span class="cstat-no" title="statement not covered" >            colorStr = colorStr.replace(/\n/g, '');</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        result.warn(RULENAME, {</span>
            node: node,
            ruleName: RULENAME,
            line: line,
            col: col,
...
<span class="cstat-no" title="statement not covered" >        global.CSSHINT_INVALID_ALL_COUNT++;</span>
    }
};
&nbsp;
/**
 ...
 */
var atRuleListIterator = <span class="fstat-no" title="function not covered" >function atRuleListIterator(atRuleList, result, rule, indentStr, startPos) {</span>
    // 说明当前这个选择器没有 atRule
<span class="cstat-no" title="statement not covered" >    if (!atRuleList.length) {</span>
<span class="cstat-no" title="statement not covered" >        (<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >            var ruleStartCol = rule.source.start.column;</span>
<span class="cstat-no" title="statement not covered" >            if (ruleStartCol - 1 !== startPos) {</span>
<span class="cstat-no" title="statement not covered" >                addWarn(rule, result, getMsg(rule.raws.before.replace(/\n/g, ''), ''));</span>
            }
&nbsp;
            // 选择器中的属性默认的缩进层级为 1
<span class="cstat-no" title="statement not covered" >            var indentLevel = 1;</span>
<span class="cstat-no" title="statement not covered" >            rule.walkDecls(<span class="fstat-no" title="function not covered" >function (decl) {</span></span>
<span class="cstat-no" title="statement not covered" >                if (!isValidVendorProp(decl, result)) {</span>
<span class="cstat-no" title="statement not covered" >                    return;</span>
                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (prefixList.indexOf(decl.prop) &gt; -1) {</span>
<span class="cstat-no" title="statement not covered" >                    return;</span>
                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                var ruleBefore = rule.raws.before;</span>
&nbsp;
                // 加上 \s，是为了防止如下情况
                // div {
                //     color: #fff;
...
<span class="cstat-no" title="statement not covered" >                ruleBefore = ruleBefore.replace(/\s*\n+/, '');</span>
&nbsp;
                // 正确的缩进字符串
<span class="cstat-no" title="statement not covered" >                var shouldIndentStr = ruleBefore;</span>
<span class="cstat-no" title="statement not covered" >                for (var j = 0; j &lt; indentLevel; j++) {</span>
<span class="cstat-no" title="statement not covered" >                    shouldIndentStr += indentStr;</span>
                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                var declBefore = decl.raws.before;</span>
                // 兼容 background-position-x: 170px;; 属性后有多个分号的情况
<span class="cstat-no" title="statement not covered" >                declBefore = declBefore.replace(/^[^\n]*/, '');</span>
                // 把 before 里面的多个空行换成一个，便于之后的计算
<span class="cstat-no" title="statement not covered" >                declBefore = declBefore.replace(/\n*/, '\n');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                var length = declBefore.length;</span>
<span class="cstat-no" title="statement not covered" >                var hackPrefixChar = declBefore[length - 1];</span>
<span class="cstat-no" title="statement not covered" >                if (hackPrefixChar === '_' || hackPrefixChar === '*') {</span>
<span class="cstat-no" title="statement not covered" >                    shouldIndentStr += hackPrefixChar;</span>
                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (declBefore !== '\n' + shouldIndentStr) {</span>
<span class="cstat-no" title="statement not covered" >                    addWarn(decl, result, getMsg(declBefore.replace(/\n/g, '').slice(0, -1), shouldIndentStr.slice(0, -1)));</span>
                }
            });
        })();
    }
&nbsp;
    // 对 atRule 处理
<span class="cstat-no" title="statement not covered" >    atRuleList.forEach(<span class="fstat-no" title="function not covered" >function (ar, index) {</span></span>
<span class="cstat-no" title="statement not covered" >        var raws = ar.raws,</span>
            source = ar.source;
&nbsp;
<span class="cstat-no" title="statement not covered" >        var arBefore = raws.before;</span>
        // 兼容 background-position-x: 170px;; 属性后有多个分号的情况
<span class="cstat-no" title="statement not covered" >        arBefore = arBefore.replace(/^[^\n]*/, '');</span>
        // 把 arBefore 里面的多个空行换成一个，便于之后的计算
<span class="cstat-no" title="statement not covered" >        arBefore = arBefore.replace(/\n*/, '\n');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        var startCol = source.start.column;</span>
&nbsp;
        // 判断第一行，只需要看开头的 col 是否等于 startPos
<span class="cstat-no" title="statement not covered" >        if (index === 0) {</span>
<span class="cstat-no" title="statement not covered" >            if (startCol - 1 !== startPos) {</span>
<span class="cstat-no" title="statement not covered" >                addWarn(ar, result, getMsg(arBefore.replace(/\n/g, ''), ''));</span>
            }
        }
        // 非第一行的 @ 选择器，那么开头就必须有缩进，缩进根据 indentStr 来计算
        else {
                // 正确的缩进字符串
<span class="cstat-no" title="statement not covered" >                var shouldIndentStr = '';</span>
<span class="cstat-no" title="statement not covered" >                for (var i = 0; i &lt; index; i++) {</span>
<span class="cstat-no" title="statement not covered" >                    shouldIndentStr += indentStr;</span>
                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (arBefore !== '\n' + shouldIndentStr) {</span>
<span class="cstat-no" title="statement not covered" >                    addWarn(ar, result, getMsg(arBefore.replace(/\n/g, '').slice(0, -1), shouldIndentStr.slice(0, -1)));</span>
                }
            }
&nbsp;
        // 最后一个 @ 选择器，在这里处理 atRule 里的 decl 以及 atRule 里的 rule
<span class="cstat-no" title="statement not covered" >        if (index === atRuleList.length - 1) {</span>
<span class="cstat-no" title="statement not covered" >            var ruleBefore = rule.raws.before;</span>
            // 兼容 background-position-x: 170px;; 属性后有多个分号的情况
<span class="cstat-no" title="statement not covered" >            ruleBefore = ruleBefore.replace(/^[^\n]*/, '');</span>
            // 把 ruleBefore 里面的多个空行换成一个，便于之后的计算
<span class="cstat-no" title="statement not covered" >            ruleBefore = ruleBefore.replace(/\n*/, '\n');</span>
&nbsp;
            // 正确的缩进字符串
<span class="cstat-no" title="statement not covered" >            var ruleShouldIndentStr = '';</span>
<span class="cstat-no" title="statement not covered" >            for (var q = 0; q &lt;= index; q++) {</span>
<span class="cstat-no" title="statement not covered" >                ruleShouldIndentStr += indentStr;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (ruleBefore !== '\n' + ruleShouldIndentStr) {</span>
<span class="cstat-no" title="statement not covered" >                addWarn(rule, result, getMsg(ruleBefore.replace(/\n/g, '').slice(0, -1), ruleShouldIndentStr.slice(0, -1)));</span>
            }
&nbsp;
            // 处理 atRule 里面的 decl，其实这里用 rule.walkDecls 也可以
<span class="cstat-no" title="statement not covered" >            ar.walkDecls(<span class="fstat-no" title="function not covered" >function (decl) {</span></span>
<span class="cstat-no" title="statement not covered" >                if (!isValidVendorProp(decl, result)) {</span>
<span class="cstat-no" title="statement not covered" >                    return;</span>
                }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                var before = decl.raws.before;</span>
                // 兼容 background-position-x: 170px;; 属性后有多个分号的情况
<span class="cstat-no" title="statement not covered" >                before = before.replace(/^[^\n]*/, '');</span>
                // 把 before 里面的多个空行换成一个，便于之后的计算
<span class="cstat-no" title="statement not covered" >                before = before.replace(/\n*/, '\n');</span>
&nbsp;
                // 正确的缩进字符串
...
<span class="cstat-no" title="statement not covered" >                for (var _i = 0; _i &lt;= index + 1; _i++) {</span>
<span class="cstat-no" title="statement not covered" >                    shouldIndentStr += indentStr;</span>
                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                var length = before.length;</span>
<span class="cstat-no" title="statement not covered" >                var hackPrefixChar = before[length - 1];</span>
<span class="cstat-no" title="statement not covered" >                if (hackPrefixChar === '_' || hackPrefixChar === '*') {</span>
<span class="cstat-no" title="statement not covered" >                    shouldIndentStr += hackPrefixChar;</span>
                }
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (before !== '\n' + shouldIndentStr) {</span>
<span class="cstat-no" title="statement not covered" >                    addWarn(decl, result, getMsg(before.replace(/\n/g, '').slice(0, -1), shouldIndentStr.slice(0, -1)));</span>
                }
            });
        }
    });
 ...
 */
var check = exports.check = _postcss2.default.plugin(RULENAME, <span class="fstat-no" title="function not covered" >function (opts) {</span>
<span class="cstat-no" title="statement not covered" >    return <span class="fstat-no" title="function not covered" >function (css, result) {</span></span>
<span class="cstat-no" title="statement not covered" >        if (!Array.isArray(opts.ruleVal)) {</span>
<span class="cstat-no" title="statement not covered" >            return;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        lineCache = 0;</span>
&nbsp;
        // 缩进的字符串
<span class="cstat-no" title="statement not covered" >        var indentStr = opts.ruleVal[0];</span>
&nbsp;
        // 开始计算缩进的偏移量，相当于这一行的 column，和 opts.ruleVal[0] 没有关系
<span class="cstat-no" title="statement not covered" >        var startPos = opts.ruleVal[1];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        css.walkRules(<span class="fstat-no" title="function not covered" >function (rule) {</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >            if (global.CSSHINT_INVALID_ALL_COUNT &gt;= opts.maxError) {</span>
<span class="cstat-no" title="statement not covered" >                return;</span>
            }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            var atRuleList = [];</span>
<span class="cstat-no" title="statement not covered" >            var parentRule = rule.parent;</span>
<span class="cstat-no" title="statement not covered" >            while (parentRule.type === 'atrule') {</span>
<span class="cstat-no" title="statement not covered" >                atRuleList.unshift(parentRule);</span>
<span class="cstat-no" title="statement not covered" >                parentRule = parentRule.parent;</span>
            }
&nbsp;
<span class="cstat-no" title="statement not covered" >            atRuleListIterator(atRuleList, result, rule, indentStr, startPos);</span>
        });
    };
});
