...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-csshint/node_modules/csshint/lib/rule/regex-selectors.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-csshint/node_modules/csshint/lib/rule/regex-selectors.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-csshint/node_modules/csshint/lib/rule/</a> &#187; regex-selectors.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >                    var attrs = selectorInGroup.match(/\[.+?\](?::[^\s&gt;+~\.#\[]+)?/g);</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                    for (var j = 0, attrsLen = attrs.length; j &lt; attrsLen; j++) {</span>
<span class="cstat-no" title="statement not covered" >                        var attr = attrs[j];</span>
<span class="cstat-no" title="statement not covered" >                        if (/([\~\|\^\$\*]=)/.test(attr)) {</span>
<span class="cstat-no" title="statement not covered" >                            var col = lineContent.indexOf(attr) + 1;</span>
