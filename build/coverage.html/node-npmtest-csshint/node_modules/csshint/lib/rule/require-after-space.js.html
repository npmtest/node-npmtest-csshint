...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-csshint/node_modules/csshint/lib/rule/require-after-space.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-csshint/node_modules/csshint/lib/rule/require-after-space.js</span></h1>
    <h2>
        
        Statements: <span class="metric">39.53% <small>(17 / 43)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">38.1% <small>(16 / 42)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-csshint/node_modules/csshint/lib/rule/</a> &#187; require-after-space.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (realRuleVal.indexOf(COLON) !== -1) {</span>
<span class="cstat-no" title="statement not covered" >                    var between = decl.raws.between;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                    if (between.slice(0, 1) !== ':' // `属性名` 与之后的 `:` 之间包含空格了</span>
                    || between.slice(-1) === ':' // `:` 与 `属性值` 之间不包含空格
                    ) {
<span class="cstat-no" title="statement not covered" >                            var colorStr = decl.prop + decl.raws.between + decl.value;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >                if (realRuleVal.indexOf(COMMA) !== -1) {</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                    if (!PATTERN_URI.test(value)) {</span>
<span class="cstat-no" title="statement not covered" >                        var items = lineContent.split(';');</span>
<span class="cstat-no" title="statement not covered" >                        for (var j = 0, jLen = items.length; j &lt; jLen; j++) {</span>
<span class="cstat-no" title="statement not covered" >                            var s = items[j];</span>
<span class="cstat-no" title="statement not covered" >                            if (s.indexOf(',') &gt; -1 &amp;&amp; /.*,(?!\s)/.test(s) &amp;&amp; s.length !== lineContent.length // s.length === lineContent.length 的情况表示当前行结束了</span>
                            ) {
<span class="cstat-no" title="statement not covered" >                                    result.warn(RULENAME, {</span>
                                        node: decl,
                                        ruleName: RULENAME,
