...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-csshint/node_modules/csshint/lib/rule/unique-headings.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-csshint/node_modules/csshint/lib/rule/unique-headings.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">28.57% <small>(12 / 42)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-csshint/node_modules/csshint/lib/rule/</a> &#187; unique-headings.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        var headings = {</span>
            h1: 0,
            h2: 0,
            h3: 0,
            h4: 0,
...
<span class="cstat-no" title="statement not covered" >            var selector = rule.selector,</span>
                source = rule.source;
&nbsp;
<span class="cstat-no" title="statement not covered" >            var selectorGroup = selector.split(',');</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            for (var i = 0, len = selectorGroup.length; i &lt; len; i++) {</span>
<span class="cstat-no" title="statement not covered" >                var selectorInGroup = selectorGroup[i] || '';</span>
<span class="cstat-no" title="statement not covered" >                var segments = selectorInGroup.split(PATTERN_COMBINATORS);</span>
<span class="cstat-no" title="statement not covered" >                var segmentLen = segments.length;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                var lastSegment = segments[segmentLen - 1];</span>
<span class="cstat-no" title="statement not covered" >                if (!lastSegment.match(':') &amp;&amp; headings.hasOwnProperty(lastSegment)) {</span>
<span class="cstat-no" title="statement not covered" >                    headings[lastSegment]++;</span>
<span class="cstat-no" title="statement not covered" >                    if (headings[lastSegment] &gt; 1) {</span>
<span class="cstat-no" title="statement not covered" >                        var newLineMatch = selectorInGroup.match(/\n/g);</span>
<span class="cstat-no" title="statement not covered" >                        var extraLine = 0;</span>
<span class="cstat-no" title="statement not covered" >                        if (newLineMatch) {</span>
<span class="cstat-no" title="statement not covered" >                            extraLine += newLineMatch.length;</span>
<span class="cstat-no" title="statement not covered" >                            line = line + extraLine;</span>
<span class="cstat-no" title="statement not covered" >                            lineContent = (0, _util.getLineContent)(line, source.input.css);</span>
<span class="cstat-no" title="statement not covered" >                            col = col + lineContent.indexOf(lastSegment);</span>
                        } else {
<span class="cstat-no" title="statement not covered" >                            col = lineContent.indexOf(lastSegment) + 1;</span>
                        }
