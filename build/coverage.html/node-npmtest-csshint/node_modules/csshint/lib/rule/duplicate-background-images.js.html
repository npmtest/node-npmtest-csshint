...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-csshint/node_modules/csshint/lib/rule/duplicate-background-images.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-csshint/node_modules/csshint/lib/rule/duplicate-background-images.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">39.39% <small>(13 / 33)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-csshint/node_modules/csshint/lib/rule/</a> &#187; duplicate-background-images.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >            if (prop.match(/background/i)) {</span>
...
<span class="cstat-no" title="statement not covered" >                while (!!(match = PATTERN_URL.exec(value))) {</span>
<span class="cstat-no" title="statement not covered" >                    if (typeof stack[match[2]] === 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >                        stack[match[2]] = decl;</span>
                    } else {
<span class="cstat-no" title="statement not covered" >                        var str = 'Background image `' + match[2] + '` was used multiple times, first declared at line ' + stack[match[2]].source.start.line + ', col ' + stack[match[2]].source.start.column + '. ' + MSG;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >                        var colorStr = 'Background image `' + _chalk2.default.magenta(match[2]) + '` was used multiple times, first declared at line ' + stack[match[2]].source.start.line + ', col ' + stack[match[2]].source.start.column + '. ' + _chalk2.default.grey(MSG);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >                        var col = lineContent.indexOf(match[2]) + 1;</span>
