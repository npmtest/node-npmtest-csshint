...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-csshint/node_modules/csshint/lib/config.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-csshint/node_modules/csshint/lib/config.js</span></h1>
    <h2>
        
        Statements: <span class="metric">70.83% <small>(17 / 24)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">69.57% <small>(16 / 23)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-csshint/node_modules/csshint/lib/</a> &#187; config.js</div>
</div>
<div class="body">
...
function loadConfig(filePath, refresh) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!refresh &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >STORAGE)</span> {
<span class="cstat-no" title="statement not covered" >        return STORAGE;</span>
    }
&nbsp;
    var manis = new _manis2.default({
        files: ['.csshintrc'],
        loader: <span class="fstat-no" title="function not covered" >function loader(content) {</span>
<span class="cstat-no" title="statement not covered" >            if (!content) {</span>
<span class="cstat-no" title="statement not covered" >                return '';</span>
            }
<span class="cstat-no" title="statement not covered" >            var ret = void 0;</span>
<span class="cstat-no" title="statement not covered" >            try {</span>
<span class="cstat-no" title="statement not covered" >                ret = _jsYaml2.default.load(content);</span>
            } catch (e) {}
